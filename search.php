<div x-data="{ dropdownOpen: false }" class="grid justify-items-center">
  ...
  <div class="search m-3 rounded-md w-auto flex items-center">
    <input @click="dropdownOpen = !dropdownOpen" class="p-2 pl-4 rounded-md w-96 focus:outline-none text-sm placeholder-opacity-25 placeholder-gray-500" type="text" placeholder="Type to search...">
    <button class="-ml-10">
